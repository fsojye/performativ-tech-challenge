...
@dataclass
class BaseMetric:
    is_open: Series[Decimal]
    price: Series[Decimal]
    value: Series[Decimal]
    return_per_period: Series[Decimal]
    return_per_period_percentage: Series[Decimal]
