...
from src.services.position_calculators.base_metric_calculator import BaseMetricCalculator
from src.services.position_calculators.price_local_calculator import PriceLocalCalculator
from src.services.position_calculators.return_per_period_calculator import ReturnPerPeriodCalculator
from src.services.position_calculators.return_per_period_percentage_calculator import (
    ReturnPerPeriodPercentageCalculator,
)
from src.services.position_calculators.value_calculator import ValueCalculator
from src.services.position_calculators.value_end_calculator import ValueEndCalculator
from src.services.position_calculators.value_start_calculator import ValueStartCalculator
...
class CalculatorFactory:
    ...
    def register(self, key, cls, deps=None):
        self._registry[key] = {
            "cls": cls,
            "deps": deps or [],
        }
    ...
    def get(self, key):
        ...
        cls, deps = self._registry.get(key)
